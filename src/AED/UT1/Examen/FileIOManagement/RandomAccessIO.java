package AED.UT1.Examen.FileIOManagement;
...
public class RandomAccessIO {
    ...
    public RandomAccessIO(String path) {
        ...
        //En caso de que exista, elimina el fichero para limpiar el contenido y evitar errores
    ...
    public int[] searchPositionById(String id, BYTES[] bytesTypes) {
        ...
        try {
            ...
            if (!exists) {
                System.err.println("Dicha poliza no existe, saliendo del programa...");
                System.exit(0);
            }
