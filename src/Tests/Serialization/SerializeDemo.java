...
public class SerializeDemo {
    ...
    public static void main(String [] args) {
        ...
        //You can override methods like this
        User user = new User() {
            @Override
            public void hello() {
                System.out.println("Welcome bebesitaaa");
            }
        };
        ...
        try {
            FileOutputStream fileOut = new FileOutputStream("H:\\Development\\IntelliJIdea\\IdeaProjects2\\src\\Tests\\Serialization\\employee.ser");
        ...
        //Method to get the SerialVersionUID of a class that is serializable
        //Can be uses to compares classes ID before saving it to an object (it can be an exception)
